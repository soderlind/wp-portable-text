...
- **Blueprint variants** — `blueprint-blocks.json` and `blueprint-editor.json` for dedicated plugin setup and demo content workflows.

### Fixed

- Corrected formatting in installation instructions of `README.md`.
- Fixed fatal error in `Query.php`.
